# KRINEIA.md — autoresearch-reports

**krineia_manifest_version:** 0.1
**schema:** krineia-manifest@0.1

This is the repo-local KRINEIA manifest for `hummbl-dev/autoresearch-reports`. It declares how this repo participates in KRINEIA governance.
...
repo:
  full_name: "hummbl-dev/autoresearch-reports"
  default_branch: "main"
  visibility: "public"
...
chains:
  primary:
    chain_id: "autoresearch-reports-primary"
